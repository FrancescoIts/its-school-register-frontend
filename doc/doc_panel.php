...
<head>
  ...
  <script src="../assets/js/doc_panel.js" defer></script>
...
<body>
  ...
  <div class="dashboard" id="calendarAdmin" data-section="calendarAdmin">
    <div class="dashboard-header">
      <h3>Calendario Eventi (Lezioni)</h3>
      <span class="toggle-icon">&#9660;</span>
    </div>
    <div class="dashboard-content">
      <div class="courses">
        <div class="course-card" id="calendarAdminContainer">
                <?php
  ...
  <div class="dashboard" id="attendanceAdmin">
    ...
    <div class="dashboard-content">
      <div class="courses">
        <div class="course-card" id="attendanceAdminContainer">
          <!-- Loader -->
  ...
  <div class="dashboard" id="Panoramica">
    ...
    <div class="dashboard-content">
      <div class="courses">
        <div class="course-card" id="modifyAttendanceContainer">
          <!-- Loader -->
              <div class="loader loader-1">
                <div class="loader-outter"></div>
                <div class="loader-inner"></div>
  ...
  <div class="dashboard" data-section="statsStudents" id="statistiche">
    ...
    <div class="dashboard-content">
      <div class="courses">
        <div class="course-card" id="statsTotalContainer">
                <?php
